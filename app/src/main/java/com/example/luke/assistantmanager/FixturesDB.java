...
public class FixturesDB extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME = "fixtures_table";
    ...
    public boolean addFixture(String text) {
     ...
     * @param oldName
     */
    public void updateFixture(String newName, int id, String oldName){
        SQLiteDatabase db = this.getWritableDatabase();
